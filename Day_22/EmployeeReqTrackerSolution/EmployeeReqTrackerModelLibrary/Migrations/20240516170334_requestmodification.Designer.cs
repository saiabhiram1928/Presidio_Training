...
namespace EmployeeReqTrackerModelLibrary.Migrations
{
    ...
    [Migration("20240516170334_requestmodification")]
    partial class requestmodification
    {
            ...
            modelBuilder.Entity("EmployeeReqTrackerModelLibrary.Request", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RequestNumber = 1,
                            RequestDate = new DateTime(2024, 5, 14, 22, 33, 34, 440, DateTimeKind.Local).AddTicks(5315),
