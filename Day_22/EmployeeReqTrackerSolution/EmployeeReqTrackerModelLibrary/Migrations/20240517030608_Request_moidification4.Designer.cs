...
namespace EmployeeReqTrackerModelLibrary.Migrations
{
    ...
    [Migration("20240517030608_Request_moidification4")]
    partial class Request_moidification4
    {
            ...
            modelBuilder.Entity("EmployeeReqTrackerModelLibrary.Request", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            RequestDate = new DateTime(2024, 5, 15, 8, 36, 8, 75, DateTimeKind.Local).AddTicks(4700),
